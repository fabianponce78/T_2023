...
def fn_01_XLS_SHEET_JIRA_STORIES():
    ...
    ###-----------------------------------------------------------------------------------------------------
    ###-----------------------------------------------------------------------------------------------------
    str_Query_01 = 'select    * from [JIRA].[dbo].[V_JIRA_Open_Past_Q] order by DT'    
    ...
    for row in cursor: 
        ...
        ws.cell(row=i, column=14).value = row[13]
        ws.cell(row=i, column=15).value = row[14]
        ws.cell(row=i, column=16).value = row[15]
        ws.cell(row=i, column=17).value = row[16]
        ws.cell(row=i, column=18).value = row[17]
        ws.cell(row=i, column=19).value = row[18]
        ws.cell(row=i, column=20).value = row[19]
        #ws.cell(row=i, column=21).value = row[20]
